...
wget https://github.com/defenseunicorns/zarf/releases/download/v0.27.1/zarf-init-amd64-v0.27.1.tar.zst
chmod +x zarf_v0.27.1_Linux_amd64
sudo mv zarf_v0.27.1_Linux_amd64 /usr/local/bin/zarf
